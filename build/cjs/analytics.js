...
(function (Analytics) {
    var Client = /** @class */ (function () {
         ...
         */
        Client.prototype.track = function (event, properties) {
            if (properties === void 0) { properties = {}; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('track', { event: event, properties: properties })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
         ...
         * If the event was 'Added to Shopping Cart', it might have properties like price, productType, etc.
         */
        Client.prototype.screen = function (name, properties) {
            if (properties === void 0) { properties = {}; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('screen', { name: name, properties: properties })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
         ...
         */
        Client.prototype.identify = function (user, traits) {
            if (traits === void 0) { traits = {}; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('identify', { user: user, traits: traits })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
         ...
         */
        Client.prototype.group = function (groupId, traits) {
            if (traits === void 0) { traits = {}; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('group', { groupId: groupId, traits: traits })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
         ...
         */
        Client.prototype.alias = function (newId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('alias', { newId: newId })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
